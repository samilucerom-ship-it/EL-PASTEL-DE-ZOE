          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-20 items-start">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                <a href="https://facebook.com" className="bg-muted p-3 rounded-full hover:bg-primary hover:text-white hover:scale-110 transition-all duration-300 luxury-shadow text-primary">
                  <Facebook className="w-6 h-6" />
                </a>
                <a href="https://instagram.com" className="bg-muted p-3 rounded-full hover:bg-primary hover:text-white hover:scale-110 transition-all duration-300 luxury-shadow text-primary">
